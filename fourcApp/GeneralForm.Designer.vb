...
Partial Class GeneralForm
    ...
    Private Sub InitializeComponent()
        ...
        سندمشترياتToolStripMenuItem = New ToolStripMenuItem()
        سندمبيعاتToolStripMenuItem = New ToolStripMenuItem()
        سندتحويلToolStripMenuItem = New ToolStripMenuItem()
        سندإهـــلاكToolStripMenuItem = New ToolStripMenuItem()
        ...
        UndoToolStripMenuItem.Text = "شجرة الحسابات"
        ' 
        ...
        RedoToolStripMenuItem.Text = "سند مصروفات"
        ' 
        ' ToolStripSeparator6
        ' 
    ...
    Friend WithEvents سندإهـــلاكToolStripMenuItem As ToolStripMenuItem
