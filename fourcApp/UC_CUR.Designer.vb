...
Partial Class UC_CUR
    ...
    Private Sub InitializeComponent()
        ...
        Btn_After = New ToolStripButton()
        ToolStripSeparator9 = New ToolStripSeparator()
        Txt_FileNo = New ToolStripTextBox()
        ...
        btn_newItem = New Guna.UI2.WinForms.Guna2Button()
        Btn_AddItem = New Guna.UI2.WinForms.Guna2Button()
        btn_updateItem = New Guna.UI2.WinForms.Guna2Button()
        btn_DeleteItem = New Guna.UI2.WinForms.Guna2Button()
        ...
        ' Btn_First
        ' 
        Btn_First.DisplayStyle = ToolStripItemDisplayStyle.Text
        Btn_First.Image = CType(resources.GetObject("Btn_First.Image"), Image)
        Btn_First.ImageTransparentColor = Color.Magenta
        Btn_First.Name = "Btn_First"
        Btn_First.Size = New Size(23, 22)
        Btn_First.Text = "|<"
        ' 
        ' ToolStripSeparator6
        ' 
        ...
        ' Btn_After
        ' 
        Btn_After.DisplayStyle = ToolStripItemDisplayStyle.Text
        Btn_After.Image = CType(resources.GetObject("Btn_After.Image"), Image)
        Btn_After.ImageTransparentColor = Color.Magenta
        Btn_After.Name = "Btn_After"
        Btn_After.Size = New Size(27, 22)
        Btn_After.Text = "<<"
        ' 
        ' ToolStripSeparator9
        ' 
        ...
        ' Txt_FileNo
        ' 
        Txt_FileNo.BackColor = Color.FromArgb(CByte(128), CByte(255), CByte(255))
        Txt_FileNo.Name = "Txt_FileNo"
        Txt_FileNo.ReadOnly = True
        Txt_FileNo.Size = New Size(233, 25)
        ' 
        ' ToolStripSeparator5
        ' 
        ...
        ' Btn_last
        ' 
        Btn_last.DisplayStyle = ToolStripItemDisplayStyle.Text
        Btn_last.Image = CType(resources.GetObject("Btn_last.Image"), Image)
        Btn_last.ImageTransparentColor = Color.Magenta
        Btn_last.Name = "Btn_last"
        Btn_last.Size = New Size(23, 22)
        Btn_last.Text = ">|"
        ' 
        ' ToolStripSeparator8
        ' 
        ...
        Guna2ShadowPanel1.Controls.Add(btn_newItem)
        Guna2ShadowPanel1.Controls.Add(Btn_AddItem)
        Guna2ShadowPanel1.Controls.Add(btn_updateItem)
        Guna2ShadowPanel1.Controls.Add(btn_DeleteItem)
        ...
        Guna2ShadowPanel1.Size = New Size(456, 48)
        ...
        btn_newItem.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        ...
        btn_updateItem.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        ...
        btn_DeleteItem.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
    ...
    Public WithEvents Btn_First As ToolStripButton
    Friend WithEvents Btn_After As ToolStripButton
    Friend WithEvents Txt_FileNo As ToolStripTextBox
    Friend WithEvents Btn_Next As ToolStripButton
    Friend WithEvents Btn_last As ToolStripButton
    Friend WithEvents Guna2Elipse1 As Guna.UI2.WinForms.Guna2Elipse
    Friend WithEvents Guna2ShadowPanel1 As Guna.UI2.WinForms.Guna2ShadowPanel
    Friend WithEvents btn_DeleteItem As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btn_newItem As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents Btn_AddItem As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btn_updateItem As Guna.UI2.WinForms.Guna2Button
End Class
