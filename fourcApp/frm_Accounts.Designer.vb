...
Partial Class frm_Accounts
    ...
    Private Sub InitializeComponent()
        ...
        Grp_AccountSub.SuspendLayout()
        Grp_AccountGeneral.SuspendLayout()
        SuspendLayout()
        ' 
        ' Guna2ControlBox1
        ' 
        ...
        Guna2Panel2.Location = New Point(367, 252)
        Guna2Panel2.Name = "Guna2Panel2"
        Guna2Panel2.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        Guna2Panel2.Size = New Size(953, 342)
        ...
        Guna2ShadowPanel1.Controls.Add(Grp_AccountSub)
        Guna2ShadowPanel1.Controls.Add(Grp_AccountGeneral)
        ...
        txt_AccountSubName.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txt_AccountSubName.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txt_AccountSubName.FillColor = Color.FromArgb(CByte(97), CByte(129), CByte(124))
        txt_AccountSubName.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        ...
        txt_AccountSubCode.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txt_AccountSubCode.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txt_AccountSubCode.FillColor = Color.FromArgb(CByte(97), CByte(129), CByte(124))
        txt_AccountSubCode.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        ...
        ' swt_AccontSubActive
        ' 
        swt_AccontSubActive.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        swt_AccontSubActive.CheckedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        ...
        swt_AccontSubActive.UncheckedState.FillColor = Color.FromArgb(CByte(125), CByte(137), CByte(149))
        swt_AccontSubActive.UncheckedState.InnerBorderColor = Color.White
        swt_AccontSubActive.UncheckedState.InnerColor = Color.White
        ' 
        ' Label3
        ' 
        ...
        txt_AccountGeneralNameAr.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txt_AccountGeneralNameAr.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txt_AccountGeneralNameAr.FillColor = Color.FromArgb(CByte(97), CByte(129), CByte(124))
        txt_AccountGeneralNameAr.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txt_AccountGeneralNameAr.Font = New Font("Segoe UI", 9F)
        txt_AccountGeneralNameAr.ForeColor = Color.White
        txt_AccountGeneralNameAr.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txt_AccountGeneralNameAr.Location = New Point(74, 91)
        ...
        Txt_AccountGeneralCode.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Txt_AccountGeneralCode.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        Txt_AccountGeneralCode.FillColor = Color.FromArgb(CByte(97), CByte(129), CByte(124))
        Txt_AccountGeneralCode.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Txt_AccountGeneralCode.Font = New Font("Segoe UI", 9F)
        Txt_AccountGeneralCode.ForeColor = Color.White
        Txt_AccountGeneralCode.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        Txt_AccountGeneralCode.Location = New Point(83, 52)
        Txt_AccountGeneralCode.Name = "Txt_AccountGeneralCode"
        ...
        Label6.Location = New Point(297, 54)
        Label6.Name = "Label6"
        Label6.Size = New Size(81, 26)
        Label6.TabIndex = 3
        Label6.Text = "كود الحساب"
        ...
        Label5.Location = New Point(283, 93)
        Label5.Name = "Label5"
        ...
        Grp_AccountSub.ResumeLayout(False)
        Grp_AccountSub.PerformLayout()
        Grp_AccountGeneral.ResumeLayout(False)
        Grp_AccountGeneral.PerformLayout()
        ResumeLayout(False)
        PerformLayout()
    End Sub
