...
Partial Class frm_Items
    ...
    Private Sub InitializeComponent()
        ...
        txt_ItemAvailableQty = New Guna.UI2.WinForms.Guna2TextBox()
        Label15 = New Label()
        ...
        com_ItemType4 = New Guna.UI2.WinForms.Guna2ComboBox()
        com_ItemType3 = New Guna.UI2.WinForms.Guna2ComboBox()
        com_ItemType1 = New Guna.UI2.WinForms.Guna2ComboBox()
        com_ItemType2 = New Guna.UI2.WinForms.Guna2ComboBox()
        Com_ItemUnit = New Guna.UI2.WinForms.Guna2ComboBox()
        Label11 = New Label()
        Label10 = New Label()
        Label9 = New Label()
        Label8 = New Label()
        ...
        Guna2ShadowPanel2.Controls.Add(txt_ItemAvailableQty)
        ...
        Guna2ShadowPanel2.Location = New Point(66, 297)
        ...
        ' 
        txt_ItemAvailableQty.Animated = True
        txt_ItemAvailableQty.BorderRadius = 10
        txt_ItemAvailableQty.CustomizableEdges = CustomizableEdges3
        txt_ItemAvailableQty.DefaultText = ""
        txt_ItemAvailableQty.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txt_ItemAvailableQty.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txt_ItemAvailableQty.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        ...
        txt_ItemAvailableQty.SelectedText = ""
        txt_ItemAvailableQty.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        txt_ItemAvailableQty.Size = New Size(130, 30)
        txt_ItemAvailableQty.TabIndex = 14
        txt_ItemAvailableQty.TextAlign = HorizontalAlignment.Center
        ' 
        ' Label15
        ' 
        ...
        Label15.TabIndex = 15
        Label15.Text = "الكميه المتاحة"
        Label15.TextAlign = ContentAlignment.MiddleRight
        ' 
        ' txt_ItemAvgCost
        ' 
        txt_ItemAvgCost.Animated = True
        txt_ItemAvgCost.BorderRadius = 10
        txt_ItemAvgCost.CustomizableEdges = CustomizableEdges5
        txt_ItemAvgCost.DefaultText = ""
        txt_ItemAvgCost.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txt_ItemAvgCost.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txt_ItemAvgCost.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        ...
        txt_ItemAvgCost.SelectedText = ""
        txt_ItemAvgCost.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        txt_ItemAvgCost.Size = New Size(130, 30)
        txt_ItemAvgCost.TabIndex = 14
        txt_ItemAvgCost.TextAlign = HorizontalAlignment.Center
        ' 
        ' Label14
        ' 
        ...
        panal_iteminfo.Controls.Add(txt_ItemPriceSell)
        panal_iteminfo.Controls.Add(txt_ItemNameEn)
        panal_iteminfo.Controls.Add(txt_ItemNameAr)
        panal_iteminfo.Controls.Add(Txt_itemCode)
        panal_iteminfo.Controls.Add(com_ItemType4)
        panal_iteminfo.Controls.Add(com_ItemType3)
        panal_iteminfo.Controls.Add(com_ItemType1)
        panal_iteminfo.Controls.Add(com_ItemType2)
        panal_iteminfo.Controls.Add(Com_ItemUnit)
        panal_iteminfo.Controls.Add(Label11)
        panal_iteminfo.Controls.Add(Label10)
        panal_iteminfo.Controls.Add(Label9)
        panal_iteminfo.Controls.Add(Label8)
        panal_iteminfo.Controls.Add(Label7)
        panal_iteminfo.Controls.Add(Label6)
        panal_iteminfo.Controls.Add(Label5)
        ...
        txt_ItemPriceSell.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        ...
        txt_ItemNameEn.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        ...
        txt_ItemNameAr.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        ...
        com_ItemType2.FocusedColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        com_ItemType2.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        com_ItemType2.Font = New Font("Cairo", 9.75F, FontStyle.Bold)
        com_ItemType2.ForeColor = Color.White
        ...
        ' Com_ItemUnit
        ' 
        Com_ItemUnit.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        ...
        Label11.Location = New Point(1240, 187)
        ...
        Label10.Location = New Point(714, 30)
        Label10.Name = "Label10"
        Label10.Size = New Size(49, 23)
        Label10.TabIndex = 14
        Label10.Text = "الفئه 1"
        Label10.TextAlign = ContentAlignment.MiddleRight
        ' 
        ' Label9
        ' 
        Label9.AutoSize = True
        Label9.Location = New Point(714, 69)
        Label9.Name = "Label9"
        ...
        Label8.Location = New Point(714, 108)
        Label8.Name = "Label8"
        ...
        Label7.Location = New Point(714, 147)
        Label7.Name = "Label7"
        ...
        Label6.Location = New Point(1231, 30)
        Label6.Name = "Label6"
        Label6.Size = New Size(71, 23)
        Label6.TabIndex = 9
        Label6.Text = "كود الصنف"
        ...
        Label5.Location = New Point(1230, 69)
        Label5.Name = "Label5"
        ...
        Label4.Location = New Point(1206, 108)
        Label4.Name = "Label4"
        ...
        Label3.Location = New Point(1249, 147)
        Label3.Name = "Label3"
        Label3.Size = New Size(53, 23)
        Label3.TabIndex = 12
        Label3.Text = "الوحــده"
    ...
    Friend WithEvents Com_ItemUnit As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents com_ItemType4 As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents com_ItemType3 As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents com_ItemType2 As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents Txt_itemCode As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents txt_ItemPriceSell As Guna.UI2.WinForms.Guna2TextBox
    ...
    Friend WithEvents txt_ItemAvailableQty As Guna.UI2.WinForms.Guna2TextBox
